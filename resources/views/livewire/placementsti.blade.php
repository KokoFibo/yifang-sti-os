<div>
    <div>
        <div class="card col-6 mx-auto mt-5">
            ...
            <div class="card-body ">
                <div class="mb-3 ">
                    <label for="nama_placement" class="form-label">Nama Placement</label>
                    <input type="text" class="form-control @error('nama_placement') is-invalid @enderror"
                        id="nama_placement" wire:model='nama_placement'>
                    @error('nama_placement')
