        ...
        <div class="card">
                    ...
                    <table class="table">
                            ...
                            <tr>
                                ...
                                <th>
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-primary mt-2" wire:click="rubah({{ $id_status }})">Rubah
                                            Status
                                        </button>

                                        <button class="btn btn-sm btn-success mt-2" wire:click='cancelUpdateStatus'>Cancel</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge {{ getStatusColor($d->status) }}">{{ getNamaStatus($d->status) }}</span>
                                </td>
                                ...
                                <td>
                                    <button class="btn
                                            btn-sm btn-warning" wire:click='show({{ $d->id }})'>Show</button>
                                    <button class="btn btn-sm btn-danger" wire:click='delete({{ $d->id }})' wire:confirm='Apakah yakin data applicant ini akan di delete?'>Delete</button>

                                    <button class="btn btn-sm btn-primary" wire:click='rubahstatus({{ $d->id }}, {{ $d->status }})'>Rubah
                                        Status</button>
                                </td>
                                @else
                                <td></td>
            ...
            <div class="d-flex">
                ...
                <li class="list-group-item">
                    ...
                    <iframe class="my-3 rounded-4" src="{{ getUrl($f->filename) }}" width="100%" height="600px"></iframe>
