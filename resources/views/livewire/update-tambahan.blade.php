            ...
            <div class="card-body">
                <div class="d-flex gap-2 flex-column flex-xl-row">
                    <div class="mb-3 col-12 col-xl-2">
                        ...
                        <input wire:model.live="user_id" type="numeric" class="form-control" id="user_id" disabled>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-xl-row flex-column gap-xl-3 gap-2">
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="uang_makan" type="numeric" type-currency="IDR" class="form-control">
                            </div>
                ...
                <div class="d-flex gap-5 mt-3">
                    <button wire:click="update"
                        class="btn btn-success nightowl-daylight">{{ __('Update') }}</button>
